...
export default function EditTripForm({ trip, initialPricingOptions }: EditTripFormProps) {
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="text" name="destination" defaultValue={trip.destination} required placeholder="Misal: Labuan Bajo" className="w-full bg-slate-50 border border-slate-200 text-slate-900 rounded-xl px-4 py-3 outline-none focus:border-blue-500" />
            </div>
          </div>
          ...
          <div>
            ...
            <input type="url" name="featuredImage" defaultValue={trip.featuredImage} required className="w-full bg-slate-50 border border-slate-200 text-slate-900 rounded-xl px-4 py-3 outline-none focus:border-blue-500" />
